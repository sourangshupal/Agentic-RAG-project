```mermaid
flowchart TD
    subgraph CACHE["Cache-First Request Pattern"]
    ...
    subgraph OBSERVABILITY["Observability Data Captured Per Request"]
    ...
    subgraph COST["Cost Comparison: Cache Hit vs Miss"]
        direction LR
